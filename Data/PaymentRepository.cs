...
public class PaymentRepository
{
  ...
  private static string SimulatePaymentGatewayInteraction(PaymentDTO paymentDto)
  {
  ...
  private static bool IsValidStatusTransition(string currentStatus, string newStatus, string orderStatus)
  {
